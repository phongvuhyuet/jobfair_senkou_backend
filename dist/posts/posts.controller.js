...
const status_resp_dto_1 = require("./dtos/status-resp.dto");
...
__decorate([
    ...
    openapi.ApiResponse({ status: 201, type: require("./dtos/status-resp.dto").StatusResponseDto }),
...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: require("./dtos/status-resp.dto").StatusResponseDto }),
    __param(0, (0, common_1.Body)()),
